    ...
    <div className='flex flex-col gap-4'>
      ...
      <div className='author-info flex justify-between items-center'>
        <div className='avatar w-1/3'>
          <Link to={author.link}>
            <IKImage src={author.avatar} w={60} className='object-cover object-center border-white rounded-full' />
          </Link>
        </div>
        <div className='w-2/3'>
      ...
      <div className='author-contacts flex gap-2'>
        ...
        <Link to='/'>
          <IKImage src='/instagram.svg' alt='IG' className='rounded-sm' w={32} />
        </Link>
      </div>
    </div>
  )
